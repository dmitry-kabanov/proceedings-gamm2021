...
\begin{figure}
  \centering
  \includegraphics[width=4in]{assets/error-fields-comparison.pdf}
  \caption{Comparison of the prediction errors for two neural networks:
  a) neural network trained with $\gamma=0$; b) neural network trained with
  $\gamma=10^{-2}$. Red arrows show the measurement locations and corresponding
  velocity directions.}%
  \label{fig:tg2d}
\end{figure}
